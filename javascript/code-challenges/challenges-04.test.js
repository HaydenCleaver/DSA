...
const updateAnimal = (arr, callback) => {
  ...
  // let newArr = []; not needed because map returns a new modified array
...
const sortPeople = (arr) => {
  return arr.sort((a,b) => a.lastName.charCodeAt() - b.lastName.charCodeAt());
};
...
const sortPeopleBetter = (arr) => {
  arr.sort(function (a,b){
    if (a.lastName.charCodeAt() === b.lastName.charCodeAt() && a.firstName.charCodeAt() === b.firstName.charCodeAt()){
      return a.age - b.age;
    }
    else if (a.lastName.charCodeAt() === b.lastName.charCodeAt()){
      return a.firstName.charCodeAt() - b.firstName.charCodeAt();
    } else {
      return a.lastName.charCodeAt() - b.lastName.charCodeAt();
    }
  });
};
